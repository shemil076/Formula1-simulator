...
public class RaceWithStartPositions extends JFrame {
    ...
    public RaceWithStartPositions() {
        ...
        startRace();
        lblStartPos.setFont(new Font("Serif",Font.BOLD,18
        ));             // set the font style
        lblStartPos.setForeground(Color.black);
...
//                break;
                ...
                System.out.println(201 + "Done");


                if (probability >= 81 && probability <=90){

                    System.out.println(206 + "Done");
...
//                break;
                ...
                System.out.println(227 + "Done");

                if (probability >= 91 && probability <=92){

                    System.out.println(231 + "Done");
...
//                break;
                ...
                System.out.println(252 + "Done");

                if (probability >= 93 && probability <=94){

                    System.out.println(256 + "Done");
...
//                break;
                ...
                System.out.println(303 + "Done");

                if (probability >= 97 && probability <=98){

                    System.out.println(307 + "Done");
...
//                break;
                ...
                System.out.println(328 + "Done");

                if (probability >= 99 && probability <=100){

                    System.out.println(332 + "Done");
